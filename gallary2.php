...
<div id="gallery" class="container-fluid">
   <div class="image-card">
    <img src="./assets/images/dynamic1.jpg" class="card img-responsive">
    <div class="overlay">
      <div class="text">चेम्बर दिवस –२०७७ तथा नेपाल चेम्बर अफ कमर्सको सत्तरीऔं बर्षको अवसरमा विभिन्न जिल्ला चेम्बर अफ कमर्सले आयोजना गरेका कार्यक्रमहरु
      </div>
      <button type="button" class="btn btn-primary btn-sm">Know More</button>
    </div>
  </div>  


  <div class="image-card">
    <img src="https://picsum.photos/500" class="card img-responsive">
    <div class="overlay">
      <div class="text">चेम्बर दिवस –२०७७ तथा नेपाल चेम्बर अफ कमर्सको सत्तरीऔं बर्षको अवसरमा विभिन्न जिल्ला चेम्बर अफ कमर्सले आयोजना गरेका कार्यक्रमहरु</div>
      <button type="button" class="btn btn-primary btn-sm">Know More</button>
    </div>
  </div>  
  ...
  <div class="image-card">
    <img src="https://picsum.photos/4100" class="card img-responsive">
    <div class="overlay">
      <div class="text">चेम्बर दिवस –२०७७ तथा नेपाल चेम्बर अफ कमर्सको सत्तरीऔं बर्षको अवसरमा विभिन्न जिल्ला चेम्बर अफ कमर्सले आयोजना गरेका कार्यक्रमहरु</div>
      <button type="button" class="btn btn-primary btn-sm">Know More</button>
    </div>
