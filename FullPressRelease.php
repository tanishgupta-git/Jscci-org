...
<div class="dynamicContainer">
     <?php
       ...
       $sql = "SELECT * FROM pressrelease WHERE pressId='$PressIdFromURL'";
    ...
    <div class="container">
      <h2 class="dynaHead"><?php echo $PressTitle; ?></h2>
      <h6 class="Date text-muted"><?php echo $DateTime; ?></h6>
        <div class="row">
        <div class="col-lg-4 order-lg-8 image_part" data-aos="fade-left">
          
          <?php if(!empty($HomePageImage)) { ?>
          <div class="dynaImage" >
            <img class="img-thumbnail img-responsive" src="UPLOAD/PRESS/<?php echo $HomePageImage ?>">
          </div>
          <?php } ?>
        
        <?php if(!empty($PressImageone)) { ?>
          <div class="dynaImage" >
            <img class="img-thumbnail img-responsive" src="UPLOAD/PRESS/<?php echo $PressImageone ?>">
          </div>
          <?php } ?>

           <?php if(!empty($PressImagetwo)) { ?>
          <div class="dynaImage" >
            <img class="img-thumbnail img-responsive" src="UPLOAD/PRESS/<?php echo $PressImagetwo ?>">
          </div>
          <?php } ?>
        ...
        <div class="col-lg-8 order-lg-4 content_prt" data-aos="fade-right">
            <p class="newsContent"><?php echo $PressContent; ?></p>
        </div>
        </div>
    </div>
